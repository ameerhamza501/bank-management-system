<?php
  ...
  $by = $_POST['by'];
   ...
   if ($by == "name") {
            $sql0 = "SELECT customer_id, first_name, last_name, account_no FROM customer
   ...
   if ($result->num_rows > 0) 
{
  ...
  <div id="dropdown<?php echo $i ?>" class="dropdown-content">
                         ...
                         <a href="edit_customer.php?customer_id=<?php echo $row["customer_id"] ?>">View / Edit</a>
  
                          <a href="transactions.php?customer_id=<?php echo $row["customer_id"] ?>">Transactions</a>
