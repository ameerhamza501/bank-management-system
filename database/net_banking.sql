...
/*!40101 SET @OLD_COLLATION_conectION=@@COLLATION_conectION */;
...
-- Procedures
--
CREATE DEFINER=`root`@`localhost` PROCEDURE `cust_details` ()  SELECT customer_id, first_name, last_name, account_no FROM customer$$
...
--
-- Table structure for table `payee1`
--

CREATE TABLE `payee1` (
  `benef_id` int(11) NOT NULL,
  `benef_customer_id` int(11) DEFAULT NULL,
...
--
-- Dumping data for table `payee1`
--

INSERT INTO `payee1` (`benef_id`, `benef_customer_id`, `email`, `phone_no`, `account_no`) VALUES
...
--
-- Table structure for table `payee3`
--
...
--
-- Dumping data for table `payee3`
--

INSERT INTO `payee3` (`benef_id`, `benef_customer_id`, `email`, `phone_no`, `account_no`) VALUES
(1, 1, 'chandandasdivakar@gmail.com', '9148042793', 123456789);

-- --------------------------------------------------------

--
-- Table structure for table `payee4`
--
...
--
-- Table structure for table `payee5`
--
...
--
-- Dumping data for table `payee5`
--

INSERT INTO `payee5` (`benef_id`, `benef_customer_id`, `email`, `phone_no`, `account_no`) VALUES
(1, 6, 'akshay@gmail.com', '914555555', 1004);

-- --------------------------------------------------------

--
-- Table structure for table `payee6`
--
...
--
-- Dumping data for table `payee6`
--

INSERT INTO `payee6` (`benef_id`, `benef_customer_id`, `email`, `phone_no`, `account_no`) VALUES
(1, 4, 'gagan@gmail.com', '914555552', 1002);
...
INSERT INTO `customer` (`customer_id`, `first_name`, `last_name`, `gender`, `dob`, `aadhar_no`, `email`, `phone_no`, `address`, `branch`, `account_no`, `pin`, `uname`, `pwd`) VALUES
...
INSERT INTO `log` (`customer_id`, `first_name`, `last_name`, `account_no`) VALUES
(2, 'USHA', 'S N', 12555),
(3, 'gagan', 'gowda', 1002),
(4, 'anil', 'vibu', 1003),
(5, 'akshay', 'u', 1004);
...
--
-- Indexes for table `payee1`
--
ALTER TABLE `payee1`
  ADD PRIMARY KEY (`benef_id`),
  ADD UNIQUE KEY `benef_customer_id` (`benef_customer_id`),
  ADD UNIQUE KEY `email` (`email`),
  ADD UNIQUE KEY `phone_no` (`phone_no`),
  ADD UNIQUE KEY `account_no` (`account_no`);

--
-- Indexes for table `payee3`
--
ALTER TABLE `payee3`
  ADD PRIMARY KEY (`benef_id`),
  ADD UNIQUE KEY `benef_customer_id` (`benef_customer_id`),
...
/*!40101 SET COLLATION_conectION=@OLD_COLLATION_conectION */;
