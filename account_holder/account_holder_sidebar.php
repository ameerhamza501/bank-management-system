...
<head>
 ...
 <link rel="stylesheet" href="manager_sidebar_style.css">
</head>
...
<body>
    ...
    <a href="javascript:void(0)" id="closebtn" style="padding: 10px 20px;"
      ...
      <a href="account_holderhome.php">Home</a>
        <a href="account_holdertransactions.php">My Transactions</a>
        <a id="label">Send/Recieve</a>
      
  <a href="payee.php">Transfer Funds</a>
        <a href="debit_credit.php">Debit/Credit</a>
