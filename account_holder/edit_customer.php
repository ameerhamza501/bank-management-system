    ...
    if(!isset($_SESSION)) 
{
 ...
 include "user_navbar.php";
    ...
    $sql0 = "SELECT * FROM customer WHERE customer_id=".$_SESSION['customer_id'];
   
 $sql1 = "SELECT * FROM passbook".$_SESSION['customer_id']." WHERE trans_id=(
                    SELECT MAX(trans_id) FROM passbook".$_SESSION['customer_id'].")";
...
<body>
    <form class="add_account_holderform" action="edit_account_holderaction.php" method="post">
...
<?php echo $_SESSION['customer_id'] ?> </label></label>
            </div>
        </div>
  ...
  <div class=container>
                ...
                <input name="firtname" size="30"
 type="text" value="<?php echo $firtname ?>" required />
            </div>
            <div  class=container>
               
 <label>Last Name :</b></label><br>
                <input name="lastname" size="30" type="text" value="<?php echo $lastname ?>" required />
