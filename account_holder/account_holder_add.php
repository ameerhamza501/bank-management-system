...
<body>
    <form class="add_account_holderform" action="account_holderadd_action.php" method="post">
  ...
  <textarea name="address" required /></textarea>
   ...
   <option value="MYSORE">MYSORE</option>
     ...
     <label>PIN(4 digit) :</b></label><br>
        ...
        <input name="pin" size="15" type="pasword" required />
            </div>
        </div>
     ...
     <div  class=container>
                ...
                <input name="cus_pwd"  type="pasword" required />
  </div>
  </div>
