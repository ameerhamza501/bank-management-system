...
<body>
    <form class="add_account_holderform" action="account_holderprofile_action.php" method="post">
 ...
 <div class="flex-container-form_header">
    ...
    <div class=container>
                <label>First Name : <label id="info_label"><?php echo $firtname ?></label></label>
            </div>
           
 <div class=container>
                <label>Last Name : <label id="info_label"><?php echo $lastname ?></label></label>
            </div>
        </div>
...
{echo "BHADRAVATHI";}
    ...
    <a href="account_holderhome.php" class="button">Home</a>
            </div>
            <div class="container">
  ...
  <button type="submit">Update</button>
      ...
      <a href="pass_change.php" class="pasword-button">Change pasword/PIN</a>
            </div>
