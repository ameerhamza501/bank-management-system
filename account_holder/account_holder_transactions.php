<?php
    ...
    if (isset($_SESSION['last_login_id'])) {
        $sql0 = "SELECT * FROM passbook".$_SESSION['last_login_id'];
    }
            ...
            <div class="flex-item-search-bar" id="fi-search-bar">
                ...
                <div class="flex-item-search-by">
                    <select name="by" onChange="window.location.href=this.value">
                        ...
                        <option value="account_holdertransactions.php?sort=tid_down">Tn. ID &darr;</option>
                        <option value="account_holdertransactions.php?sort=tid_up">Tn. ID &uarr;</option>
                        <option value="account_holdertransactions.php?sort=date_down">Date &darr;</option>
                        <option value="account_holdertransactions.php?sort=date_up">Date &uarr;</option>
                    </select>
                </div>
