...
*/
    ...
    $sender_id = $_SESSION['last_login_id'];
  
  $amt = mysqli_real_escape_string($conn, $_POST["amt"]);
    $pasword = mysqli_real_escape_string($conn, $_POST["pasword"]);

  
  $sql0 = "SELECT * FROM customer WHERE customer_id=".$sender_id." AND pwd='".$pasword."'";
    $result0 = $conn->query($sql0);
   
 $row0 = $result0->fetch_assoc();

    $sql5 = "SELECT * FROM customer WHERE customer_id=".$receiver_id;
...
<body>
 ...
 <div class="flex-container">
        <div class="flex-item">
            ...
            if ($err_no == -1) { ?>
                <p id="info">
<?php echo "conection Error ! Please try again later.\n"; ?></p>
            <?php } ?>
...
<p id="info"><?php echo "Wrong pasword entered !\n"; ?></p>
            <?php } ?>
        </div>
